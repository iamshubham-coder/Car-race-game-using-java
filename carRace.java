...
// graphic aur game logic k liye ye class
class CarGame extends JFrame implements KeyListener,ActionListener
{

    private int xpos=300; // x position
    private int ypos=700; // y position
    private ImageIcon car; // car image
    private Timer timer;
    Random random=new Random(); // random number generator

    private int num1=400,num2=0,num3=0; // rokne wale ka x position
    private int tree1ypos=400,tree2ypos=-200,tree3ypos=-500,tree4ypos=100,tree5ypos=-300,tree6ypos=500; // rokne wale ka y position
    private int roadmove=0; // road  ka y position
    private int carxpos[]={100,200,300,400,500}; // car ka x positoion
    private int carypos[]= {-240,-480,-720,-960,-1200}; // Car ka y position
   ...
   //graphics functions
    public void paint(Graphics g)
    {
        ...
        g.setColor(new Color(0x1057F1)); // set the color of the road
...
//road line
        ...
        tree1.paintIcon(this, g, 0, tree1ypos); // tree image on screen
        num1=random.nextInt(500); // random number generate
...
// load the opponent image for car
        ...
        if(y1pos>700)
        {
            ...
            y1pos=carypos[cypos1]; // reset the y position of opponent car
